                              ...
                              <div className="flex justify-between items-center">
                                ...
                                <div className="text-right">
                                  <div className="text-xl font-bold text-gray-900">
                                    {formatCurrency(convertAndGetDisplayPrice(item.product.price * item.quantity))}
                                  </div>
                                  <div className="text-sm text-gray-500">
                                    {formatCurrency(convertAndGetDisplayPrice(item.product.price))} each
                                  </div>
                                </div>
                              </div>
                            </div>
            ...
            <div className="xl:w-1/3">
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                  {/* Summary Header */}
                  <div
                      className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-b border-gray-100">
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-semibold">{formatCurrency(convertAndGetDisplayPrice(subtotal))}</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">{t("cart.order_tax")}</span>
                        <span className="font-semibold">{formatCurrency(convertAndGetDisplayPrice(taxAmount))}</span>
                      </div>
                      {discount > 0 && (
                          <motion.div
                        ...
                        <span className="flex items-center gap-2">
                          ...
                          {t("cart.discount")}
                            ...
                            <span
                                className="font-semibold">-{formatCurrency(convertAndGetDisplayPrice(discount))}</span>
                          </motion.div>
                      )}
                      <div className="border-t pt-3">
                      <div className="flex justify-between items-center">
                                                <span
                                                    className="text-lg font-bold text-gray-900">{t("cart.order_total")}</span>
                          <span
                              className="text-2xl font-bold text-gray-900">{formatCurrency(convertAndGetDisplayPrice(total))}</span>
                        </div>
                      </div>
                    </div>
